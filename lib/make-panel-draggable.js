...
function makePanelDraggable(sdkPanel) {
  ...
  dragHandle.setAttribute('style', 'font-size:30px; width:320px; height:180px; background: rgba(0,0,0,0); color: white');
  ...
  dragHandle.setAttribute('width', 320);
  dragHandle.setAttribute('height', 180);
