...
function makePanelDraggable(sdkPanel) {
  ...
  dragHandle.setAttribute('value', 'X');
  dragHandle.setAttribute('style', 'font-size:30px; width:15px; height:15px; background: rgba(0,0,0,0); color: white; cursor: grab');
  ...
  dragHandle.setAttribute('left', 30);
  dragHandle.setAttribute('top', 10);
