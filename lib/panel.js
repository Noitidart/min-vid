...
function create(dimensions, panelOptions) {
  ...
  // OK, this is a little weird. But let's try it. Manually set the
  // iframe's URL if it looks strange.
  console.log('panel#create: sdkPanel.contentURL is ', sdkPanel.contentURL);
  if (sdkPanel.contentURL.indexOf('default.html') == -1) {
    console.log('panel#create: The sdk URL was wrong. Resetting.');
    sdkPanel.contentURL = panelOptions.contentURL;
  }
}
